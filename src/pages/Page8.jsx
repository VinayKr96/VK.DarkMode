...
const Page8=()=>{
  ...
  return(
    ...
    <>
    <div className='h-[115vh] relative p-10 bg-white'>
        <div className=' relative h-[105vh] w-full overflow-hidden object-cover 
         bg-[url(https://static.wixstatic.com/media/f1c650_1baf8f9dcad444669565ec73ee697a92~mv2.jpg/v1/fill/w_1857,h_911,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/Background%20Anzo_Studio.jpg)] rounded-[30px]'>
            <div>
            <h1 className='font-[anzo4] text-white text-[50vh] uppercase ml-8 mt-[-10vh] absolute'>RIGHT</h1>
            <h1 className='font-[anzo4] text-zinc-300 text-[50vh] uppercase ml-8 mt-[30vh] absolute'>FIT</h1>

            </div>
            <div className='text-[2.4vh] gap-4 mb-10 mt-8 ml-[70vh] h-[80vh] w-[50vw]'>
              <h3 className='mt-10'>
            ...
            <div className=' ml-8  w-[20vw] absolute'>
